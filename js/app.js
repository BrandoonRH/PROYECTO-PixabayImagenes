...
function buscarImagenes() {
    ...
    const key = '28312059-1a702007b263dd289b0edff02';
...
function mostrarPaginacion() {
    ...
    while( true ) {
        ...
        botonSiguiente.classList.add('siguiente', 'bg-yellow-400', 'px-4', 'py-1', 'mr-2', 'mx-auto', 'mb-3', 'font-bold', 'uppercase', 'rounded');
